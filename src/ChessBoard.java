...
public class ChessBoard {
    ...
    public ChessBoard copyBoard() {
        ChessBoard newBoard = new ChessBoard(this.nowPlayer);
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
        ...
        if (nowPlayer.equals("White")) {
            ...
            if (board[0][0].getSymbol().equals("R") && board[0][4].getSymbol().equals("K") &&
                ...
                if (board[0][0].getColor().equals("White") && board[0][4].getColor().equals("White") &&
                        ...
                        !King.isUnderAttack(this, 0, 2, nowPlayer)) {
                    board[0][4] = null;
            ...
            if (board[7][0].getSymbol().equals("R") && board[7][4].getSymbol().equals("K") &&
                ...
                if (board[7][0].getColor().equals("Black") && board[7][4].getColor().equals("Black") &&
                        ...
                        !King.isUnderAttack(this, 7, 2, nowPlayer)) {
                    board[7][4] = null;
        ...
        if (nowPlayer.equals("White")) {
            ...
            if (board[0][7].getSymbol().equals("R") && board[0][4].getSymbol().equals("K") &&
                ...
                if (board[0][7].getColor().equals("White") && board[0][4].getColor().equals("White") &&
                        ...
                        !King.isUnderAttack(this, 0, 6, nowPlayer)) {
                    board[0][4] = null;
            ...
            if (board[7][7].getSymbol().equals("R") && board[7][4].getSymbol().equals("K") &&
                ...
                if (board[7][7].getColor().equals("Black") && board[7][4].getColor().equals("Black") &&
                        ...
                        !King.isUnderAttack(this, 7, 6, nowPlayer)) {
                    board[7][4] = null;
    ...
    public boolean moveToPosition(int startLine, int startColumn, int endLine, int endColumn) {
        if (checkPos(startLine) && checkPos(startColumn) && checkPos(endLine) && checkPos(endColumn)) {
            ...
            if (board[startLine][startColumn].canMoveToPosition(this, startLine, startColumn, endLine, endColumn)) {
                ...
                ChessBoard tempBoard = this.copyBoard();
                tempBoard.board[endLine][endColumn] = tempBoard.board[startLine][startColumn];
                tempBoard.board[startLine][startColumn] = null;

                if (tempBoard.board[endLine][endColumn] instanceof King) {
                    ((King) tempBoard.board[endLine][endColumn]).updatePosition(endLine, endColumn);
                }
                // Проверка безопасности короля перед выполнением хода
                if (nowPlayer.equals("White")) {
                    if (King.isUnderAttack(tempBoard, King.getKingLineW(), King.getKingColumnW(), nowPlayer)) {
                        return false;
                    }
                } else {
                    if (King.isUnderAttack(tempBoard, King.getKingLineB(), King.getKingColumnB(), nowPlayer)) {
                        return false;
                    }
                }
                ...
                if (board[endLine][endColumn] instanceof King) {
                    ((King) board[endLine][endColumn]).updatePosition(endLine, endColumn);
                }

                if (board[endLine][endColumn] instanceof Rook || board[endLine][endColumn] instanceof King) {
